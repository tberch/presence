// SSL Audio Event Detector Test Script
// This script tests all components of the audio event detector using HTTPS

const API_BASE_URL = 'https://api.talkstudio.space';
...
async function testWebSocket() {
  ...
  return new Promise((resolve) => {
    try {
      const ws = new WebSocket(`wss://api.talkstudio.space/realtime-detection`);
...
async function runAllTests() {
  console.log('==== SSL AUDIO EVENT DETECTOR TEST SUITE ====');
